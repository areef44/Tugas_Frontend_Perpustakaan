        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="country" class="form-control" value= {{ $authors["country"] }} >
            </div>

            <div class="form-group">
              <label for="">Tanggal Lahir: </label>
              <input type="date" name="birth_date" class="form-control" value= {{ $authors["birth_date"] }}>
            </div> 

            <div class="form-group">
              <label for="">Biodata: </label>
              <textarea name="bio" id="" cols="30" rows="10"> {{ $authors["bio"] }} </textarea>
            </div>
