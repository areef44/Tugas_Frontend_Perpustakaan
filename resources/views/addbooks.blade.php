        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="publisher" class="form-control" placeholder="Masukan Nama Penerbit">
            </div>
            
            <div class="form-group">
              <label for="">Tahun Terbit: </label>
              <input type="date" name="released_date" class="form-control" placeholder="Masukan Tahun Terbit">
            </div>

             <div class="form-group">
              <label for="">Tahun Cetak: </label>
              <input type="date" name="print_date" class="form-control" placeholder="Masukan Tahun Cetak">
            </div>

            <div class="form-group">
              <label for="">Jumlah Halaman: </label>
              <input type="number" name="pages_number" class="form-control" placeholder="Masukan Jumlah Halaman">
            </div>

             <div class="form-group">
              <label for="">Rating: </label>
              <input type="number" step=0.01 name="rating" class="form-control" placeholder="Masukan Rating Buku">
            </div> 
